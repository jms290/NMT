...
NewSurface
        SurfaceFormat = ASCII
        SurfaceType = GIFTI
        SurfaceName = lh.WM_inflated.gii
        LocalDomainParent = lh.WM.gii
...
NewSurface
        SurfaceFormat = ASCII
        SurfaceType = GIFTI
        SurfaceName = rh.WM_inflated.gii
        LocalDomainParent = rh.WM.gii
...
NewSurface
        SurfaceFormat = ASCII
        SurfaceType = GIFTI
        SurfaceName = rh.mid_inflated.gii
        LocalDomainParent = rh.mid.gii
...
NewSurface
        SurfaceFormat = ASCII
        SurfaceType = GIFTI
        SurfaceName = lh.mid_inflated.gii
        LocalDomainParent = lh.mid.gii
...
NewSurface
        SurfaceFormat = ASCII
        SurfaceType = GIFTI
        SurfaceName = lh.GM_inflated.gii
        LocalDomainParent = lh.GM.gii
...
NewSurface
        SurfaceFormat = ASCII
        SurfaceType = GIFTI
        SurfaceName = rh.GM_inflated.gii
        LocalDomainParent = rh.GM.gii
