...
echo "		tcsh ../../NMT_subject_align.csh Example_Subject.nii.gz ../../NMT.nii.gz ../../atlases/D99_atlas/D99_atlas_1.2a_al2NMT.nii.gz"
echo "	   If you would like to forgo aligning the D99 atlas, simply remove ../../atlases/D99_atlas/D99_atlas_1.2a_al2NMT.nii.gz from the command:"
...
then
	...
	tcsh ../../NMT_subject_align.csh Example_Subject.nii.gz ../../NMT.nii.gz ../../atlases/D99_atlas/D99_atlas_1.2a_al2NMT.nii.gz
